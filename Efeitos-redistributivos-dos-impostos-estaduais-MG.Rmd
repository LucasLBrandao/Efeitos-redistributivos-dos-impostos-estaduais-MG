...
kable(tabela_media_part, digits = 2,col.names = c("Classe",
                                                  "Renda Total média",
                                                  "Renda pós IPVA média",
                                                  "Renda pós ICMS média",
                                                  "% da Renda média",
                                                  "% da Renda pós IPVA",
                                                  "% da Renda pós ICMS",
                                                  "Variação pós IPVA",
...
kable(tabela_media, digits = 2,col.names =c("Classe",
                                            "Renda Total média",
                                            "Gasto com IPVA médio",
                                            "Gasto com ICMS médio",
                                            "Gasto com Impostos estaduais médio",
                                            "% da renda gasta com IPVA",
                                            "% da renda gasta com ICMS",
                                            "% da renda gasta com impostos estaduais"))
rm(tabela_media)
...
tabela_participacao_pos <- tabela_participacao_pos %>% select(-c(renda_total_se,
                                                                 renda_pos_ipva_total_se,
                                                                 renda_pos_icms_total_se))

kable(tabela_participacao_pos,digits = 2,col.names = c("Classe",
                                                       "Renda total",
                                                       "Renda total pós IPVA",
                                                       "Renda total pós ICMS",
                                                       "% da Renda total",
                                                       "% da Renda total pós IPVA",
                                                       "% da Renda total pós ICMS"))
...
tabela_participacao <- tabela_participacao %>% select(-c(renda_total_se,
                                                         despesa_ipva_total_se,
                                                         despesa_icms_total_se,
                                                         despesa_total_se))

kable(tabela_participacao,digits = 2,col.names = c("Classe",
                                                   "Renda total",
                                                   "Gasto total com IPVA",
                                                   "Gasto total com ICMS",
                                                   "Gasto total com os impostos",
                                                   "% da Renda total",
                                                   "% do Gasto com IPVA",
                                                   "% do Gasto com ICMS",
                                                   "% do Gasto com os impostos"))
